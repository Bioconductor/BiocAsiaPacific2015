...
- docker and Amazon Machine Instance containers
- `Rsamtools::pileup()`
- [Homo.sapiens](http://bioconductor.org/packages/Homo.sapiens) and
  friends
- Landing page 'shields' for users and developers
